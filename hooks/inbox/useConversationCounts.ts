 ...
 *
 * Quem atualiza na hora é o canal de `conversations` (invalida esta query).
 * O intervalo é só a rede de segurança — o React Query já não polla com a
 * aba em fundo (`refetchIntervalInBackground` default false).
 */
